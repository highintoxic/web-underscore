						...
						{isMenuOpen && (
							...
							>
								<div className='py-1' role='none'>
									<a
										href='#'
										className='block  px-4 py-2 rounded-t-2xl text-sm text-white hover:bg-[#729EA1] hover:text-white/80'
										role='menuitem'
									>
										Sign in
									</a>
									<a
										href='#'
										className='block px-4 py-2 rounded-b-2xl  text-sm text-white hover:bg-[#729EA1] hover:text-white/80'
										role='menuitem'
									>
										Sign up
									</a>
