                  ...
                  {selectedCalculator &&
                    ...
                    selectedCalculator !== "MentalHealth" && (
                      <button
                        ...
                        className="w-full sm:w-auto bg-blue-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-md text-xs sm:text-sm md:text-base font-medium hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 hover:cursor-pointer"
                      >
                        Calculate
                      </button>
                    )}
