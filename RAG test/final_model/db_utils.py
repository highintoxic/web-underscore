...
DB_URI = "mongodb://localhost:27017/"  # Change if using a remote MongoDB instance
DB_NAME = "rag_app"
...
def insert_application_logs(session_id, question, answer, model):
...
def get_all_documents():
    ...
    return [{"file_id": str(doc["_id"]), "filename": doc["filename"], "upload_timestamp": doc["upload_timestamp"]}
